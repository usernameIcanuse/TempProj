...
namespace DX
{
    void XM_CALLCONV Draw(shared_ptr<DirectX::PrimitiveBatch<DirectX::VertexPositionColor>> batch,
    ...
    void XM_CALLCONV DrawGrid(shared_ptr<DirectX::PrimitiveBatch<DirectX::VertexPositionColor>> batch,
    ...
    void XM_CALLCONV DrawRing(shared_ptr<DirectX::PrimitiveBatch<DirectX::VertexPositionColor>> batch,
        DirectX::FXMVECTOR origin, DirectX::FXMVECTOR majorAxis, DirectX::FXMVECTOR minorAxis,
        DirectX::GXMVECTOR color = DirectX::Colors::White);

    void XM_CALLCONV DrawRay(shared_ptr<DirectX::PrimitiveBatch<DirectX::VertexPositionColor>> batch,
        DirectX::FXMVECTOR origin, DirectX::FXMVECTOR direction, bool normalize = true,
        DirectX::FXMVECTOR color = DirectX::Colors::White);

    void XM_CALLCONV DrawTriangle(shared_ptr<DirectX::PrimitiveBatch<DirectX::VertexPositionColor>> batch,
