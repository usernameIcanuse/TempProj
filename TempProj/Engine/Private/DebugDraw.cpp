...
namespace
{
    inline void XM_CALLCONV DrawCube(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
        CXMMATRIX matWorld,
        FXMVECTOR color)
    {
...
void XM_CALLCONV DX::Draw(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
...
void XM_CALLCONV DX::DrawGrid(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
    FXMVECTOR xAxis,
    FXMVECTOR yAxis,
    FXMVECTOR origin,
    size_t xdivs,
...
void XM_CALLCONV DX::DrawRing(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
    FXMVECTOR origin,
    FXMVECTOR majorAxis,
    FXMVECTOR minorAxis,
    GXMVECTOR color)
...
void XM_CALLCONV DX::DrawRay(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
    FXMVECTOR origin,
    FXMVECTOR direction,
    bool normalize,
    FXMVECTOR color)
...
void XM_CALLCONV DX::DrawTriangle(shared_ptr<PrimitiveBatch<VertexPositionColor>> batch,
    FXMVECTOR pointA,
    FXMVECTOR pointB,
    FXMVECTOR pointC,
    GXMVECTOR color)
