...
class CCorvusState_Short_Claw_Atk3 :
    public CCorvusStateBase
{

    GAMECLASS_H(CCorvusState_Short_Claw_Atk3);
    SHALLOW_COPY(CCorvusState_Short_Claw_Atk3)
        CLONE_H(CCorvusState_Short_Claw_Atk3, CComponent)
