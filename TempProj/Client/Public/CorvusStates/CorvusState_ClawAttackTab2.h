...
class CCorvusState_ClawAttackTab2 :
    public CCorvusStateBase
{

    GAMECLASS_H(CCorvusState_ClawAttackTab2);
    SHALLOW_COPY(CCorvusState_ClawAttackTab2)
        CLONE_H(CCorvusState_ClawAttackTab2, CComponent)
