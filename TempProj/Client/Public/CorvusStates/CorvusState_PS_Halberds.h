...
BEGIN(Client)
class CCorvusState_PS_Halberds final :
    public CCorvusState_PS
{
    GAMECLASS_H(CCorvusState_PS_Halberds);
	CLONE_H(CCorvusState_PS_Halberds, CComponent);
	SHALLOW_COPY(CCorvusState_PS_Halberds);
