...
class CCorvusState_Short_Claw_Atk2 :
    public CCorvusStateBase
{

    GAMECLASS_H(CCorvusState_Short_Claw_Atk2);
    SHALLOW_COPY(CCorvusState_Short_Claw_Atk2)
        CLONE_H(CCorvusState_Short_Claw_Atk2, CComponent)
