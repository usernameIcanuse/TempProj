...
class CCorvusState_Short_AvoidR :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_Short_AvoidR);
    CLONE_H(CCorvusState_Short_AvoidR, CComponent)
        SHALLOW_COPY(CCorvusState_Short_AvoidR)
