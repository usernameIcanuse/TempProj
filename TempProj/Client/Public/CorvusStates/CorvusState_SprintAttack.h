...
class CCorvusState_SprintAttack :
    public CCorvusStateBase
{

    GAMECLASS_H(CCorvusState_SprintAttack);
    SHALLOW_COPY(CCorvusState_SprintAttack)
        CLONE_H(CCorvusState_SprintAttack, CComponent)
