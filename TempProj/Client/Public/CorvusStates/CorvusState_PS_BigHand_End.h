...
BEGIN(Client)
class CCorvusState_PS_BigHand_End final :
    public CCorvusState_PS
{
    GAMECLASS_H(CCorvusState_PS_BigHand_End);
    CLONE_H(CCorvusState_PS_BigHand_End, CComponent);
    SHALLOW_COPY(CCorvusState_PS_BigHand_End);
