...
BEGIN(Client)
class CCorvusState_PS_UrdSword final :
    public CCorvusState_PS
{
    GAMECLASS_H(CCorvusState_PS_UrdSword);
    CLONE_H(CCorvusState_PS_UrdSword, CComponent);
    SHALLOW_COPY(CCorvusState_PS_UrdSword);
