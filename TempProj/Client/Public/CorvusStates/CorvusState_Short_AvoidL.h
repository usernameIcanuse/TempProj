...
class CCorvusState_Short_AvoidL :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_Short_AvoidL);
    CLONE_H(CCorvusState_Short_AvoidL, CComponent)
        SHALLOW_COPY(CCorvusState_Short_AvoidL)
