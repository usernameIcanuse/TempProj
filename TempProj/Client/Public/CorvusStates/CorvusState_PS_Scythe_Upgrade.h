...
BEGIN(Client)
class CCorvusState_PS_Scythe_Upgrade :
    public CCorvusState_PS
{
    GAMECLASS_H(CCorvusState_PS_Scythe_Upgrade);
	CLONE_H(CCorvusState_PS_Scythe_Upgrade, CComponent);
	SHALLOW_COPY(CCorvusState_PS_Scythe_Upgrade);
