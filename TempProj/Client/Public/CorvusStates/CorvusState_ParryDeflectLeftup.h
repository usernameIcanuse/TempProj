...
class CCorvusState_ParryDeflectLeftup :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_ParryDeflectLeftup);
    CLONE_H(CCorvusState_ParryDeflectLeftup, CComponent)
        SHALLOW_COPY(CCorvusState_ParryDeflectLeftup)
