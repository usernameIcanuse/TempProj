...
class CCorvusState_LV2M_Execution :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_LV2M_Execution);
    CLONE_H(CCorvusState_LV2M_Execution, CComponent)
        SHALLOW_COPY(CCorvusState_LV2M_Execution)
