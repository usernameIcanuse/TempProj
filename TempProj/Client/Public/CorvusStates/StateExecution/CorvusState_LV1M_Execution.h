...
class CCorvusState_LV1M_Execution :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_LV1M_Execution);
    CLONE_H(CCorvusState_LV1M_Execution, CComponent)
        SHALLOW_COPY(CCorvusState_LV1M_Execution)
