...
class CCorvusState_AromorLV1_NCamera_Execution :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_AromorLV1_NCamera_Execution);
    CLONE_H(CCorvusState_AromorLV1_NCamera_Execution, CComponent)
        SHALLOW_COPY(CCorvusState_AromorLV1_NCamera_Execution)
