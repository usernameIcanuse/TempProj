...
class CCorvusState_Execution_Start:
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_Execution_Start);
    CLONE_H(CCorvusState_Execution_Start, CComponent)
        SHALLOW_COPY(CCorvusState_Execution_Start)
