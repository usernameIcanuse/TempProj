...
class CCorvusState_Armor_Execution_01 :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_Armor_Execution_01);
    CLONE_H(CCorvusState_Armor_Execution_01, CComponent)
        SHALLOW_COPY(CCorvusState_Armor_Execution_01)
