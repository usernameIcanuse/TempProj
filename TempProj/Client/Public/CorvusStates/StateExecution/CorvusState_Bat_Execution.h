...
class CCorvusState_Bat_Execution:
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_Bat_Execution);
    CLONE_H(CCorvusState_Bat_Execution, CComponent)
        SHALLOW_COPY(CCorvusState_Bat_Execution)
