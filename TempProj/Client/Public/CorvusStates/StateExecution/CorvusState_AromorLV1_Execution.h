...
class CCorvusState_AromorLV1_Execution :
    public CCorvusStateBase
{
    GAMECLASS_H(CCorvusState_AromorLV1_Execution);
    CLONE_H(CCorvusState_AromorLV1_Execution, CComponent)
        SHALLOW_COPY(CCorvusState_AromorLV1_Execution)
