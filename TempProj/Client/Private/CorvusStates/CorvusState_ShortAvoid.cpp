...
GAMECLASS_C(CCorvusState_ShortAvoid);
CLONE_C(CCorvusState_ShortAvoid, CComponent)

HRESULT CCorvusState_ShortAvoid::Initialize_Prototype()
{
	__super::Initialize_Prototype();
	return S_OK;
}

HRESULT CCorvusState_ShortAvoid::Initialize(void* pArg)
{
...
void CCorvusState_ShortAvoid::Start()
{
	__super::Start();
	
	m_pModelCom = m_pOwner.lock()->Get_Component<CModel>();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_AvoidShort_F");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_ShortAvoid::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_ShortAvoid::Tick(_float fTimeDelta)
{
...
void CCorvusState_ShortAvoid::LateTick(_float fTimeDelta)
{
...
void CCorvusState_ShortAvoid::Check_InputAgainAvoid()
{
...
void CCorvusState_ShortAvoid::OnDisable()
{

}

void CCorvusState_ShortAvoid::OnStateStart(const _float& In_fAnimationBlendTime)
{
...
void CCorvusState_ShortAvoid::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_ShortAvoid::Free()
{
	if (m_pModelCom.lock())
		m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_ShortAvoid::Call_AnimationEnd, this, placeholders::_1);
}

_bool CCorvusState_ShortAvoid::Check_AndChangeNextState()
{
...
_bool CCorvusState_ShortAvoid::Check_RuquireMnetRepeatAvoidkState()
{
