...
void CCorvusState_CheckPointEnd::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_CheckPointEnd::Call_AnimationEnd, this, placeholders::_1);
}
...
void CCorvusState_CheckPointEnd::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
