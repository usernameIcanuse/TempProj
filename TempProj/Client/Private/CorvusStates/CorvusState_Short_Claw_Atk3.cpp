...
GAMECLASS_C(CCorvusState_Short_Claw_Atk3);
CLONE_C(CCorvusState_Short_Claw_Atk3, CComponent)

HRESULT CCorvusState_Short_Claw_Atk3::Initialize_Prototype()
{
...
HRESULT CCorvusState_Short_Claw_Atk3::Initialize(void* pArg)
{
...
void CCorvusState_Short_Claw_Atk3::Start()
{
	__super::Start();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_Raven_ClawShortV2_Fast03");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Short_Claw_Atk3::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_Short_Claw_Atk3::Tick(_float fTimeDelta)
{
...
void CCorvusState_Short_Claw_Atk3::LateTick(_float fTimeDelta)
{
...
void CCorvusState_Short_Claw_Atk3::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Short_Claw_Atk3::Call_NextAnimationKey(const _uint& In_iKeyIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Short_Claw_Atk3::Attack()
{

}

void CCorvusState_Short_Claw_Atk3::Check_InputNextAttack()
{
...
void CCorvusState_Short_Claw_Atk3::OnStateStart(const _float& In_fAnimationBlendTime)
{
...
void CCorvusState_Short_Claw_Atk3::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_Short_Claw_Atk3::OnEventMessage(_uint iArg)
{
...
void CCorvusState_Short_Claw_Atk3::OnDestroy()
{
	m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_Short_Claw_Atk3::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_Short_Claw_Atk3::Free()
{

}

_bool CCorvusState_Short_Claw_Atk3::Check_AndChangeNextState()
{
	...
	if (m_pModelCom.lock()->Get_CurrentAnimation().lock()->Get_fAnimRatio() > 0.25f)
	{
		...
		{
			Rotation_InputToLookDir();
			Get_OwnerPlayer()->Change_State<CCorvusState_Short_Claw_Atk3>();
			return true;
		}
	}
...
_bool CCorvusState_Short_Claw_Atk3::Check_RequirementNextAttackState()
{
...
_bool CCorvusState_Short_Claw_Atk3::Check_RuquireMnetFirstAttackState()
{
