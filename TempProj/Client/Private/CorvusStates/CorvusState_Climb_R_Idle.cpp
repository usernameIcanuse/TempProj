...
GAMECLASS_C(CCorvusState_Climb_R_Idle);
CLONE_C(CCorvusState_Climb_R_Idle, CComponent)

HRESULT CCorvusState_Climb_R_Idle::Initialize_Prototype()
{
	__super::Initialize_Prototype();
	return S_OK;
}

HRESULT CCorvusState_Climb_R_Idle::Initialize(void* pArg)
{
...
void CCorvusState_Climb_R_Idle::Start()
{
	__super::Start();
	m_pModelCom = m_pOwner.lock()->Get_Component<CModel>();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_Ladder_R_Idle");
...
void CCorvusState_Climb_R_Idle::LateTick(_float fTimeDelta)
{
...
void CCorvusState_Climb_R_Idle::OnStateEnd()
{
	__super::OnStateEnd();
}
...
_bool CCorvusState_Climb_R_Idle::Check_AndChangeNextState()
{
