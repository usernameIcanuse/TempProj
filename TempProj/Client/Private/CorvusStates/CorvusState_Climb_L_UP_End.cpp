...
HRESULT CCorvusState_Climb_L_UP_End::Initialize_Prototype()
{
	__super::Initialize_Prototype();
	return S_OK;
}

HRESULT CCorvusState_Climb_L_UP_End::Initialize(void* pArg)
{
...
void CCorvusState_Climb_L_UP_End::Start()
{
	__super::Start();
	m_pModelCom = m_pOwner.lock()->Get_Component<CModel>();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_Ladder_Climb_L_UP_End");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Climb_L_UP_End::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_Climb_L_UP_End::Tick(_float fTimeDelta)
{
...
void CCorvusState_Climb_L_UP_End::LateTick(_float fTimeDelta)
{
...
void CCorvusState_Climb_L_UP_End::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Climb_L_UP_End::Free()
{
	
}

_bool CCorvusState_Climb_L_UP_End::Check_AndChangeNextState()
{
