...
GAMECLASS_C(CCorvusState_Bat_Execution);
CLONE_C(CCorvusState_Bat_Execution, CComponent)

HRESULT CCorvusState_Bat_Execution::Initialize_Prototype()
{
	__super::Initialize_Prototype();
	return S_OK;
}

HRESULT CCorvusState_Bat_Execution::Initialize(void* pArg)
{
...
void CCorvusState_Bat_Execution::Start()
{
	__super::Start();
...
void CCorvusState_Bat_Execution::LateTick(_float fTimeDelta)
{
...
void CCorvusState_Bat_Execution::OnDisable()
{

}

void CCorvusState_Bat_Execution::OnStateStart(const _float& In_fAnimationBlendTime)
{
	...
	//m_ThisStateAnimationCom.lock()->CallBack_NextChannelKey += bind(&CCorvusState_Bat_Execution::Call_NextAnimationKey, this, placeholders::_1);
...
void CCorvusState_Bat_Execution::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_Bat_Execution::Call_NextAnimationKey(const _uint& In_iKeyIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Bat_Execution::OnEventMessage(weak_ptr<CBase> pArg)
{

}

void CCorvusState_Bat_Execution::Free()
{
