...
HRESULT CCorvusState_AVoidThrust::Initialize(void* pArg)
{
...
void CCorvusState_AVoidThrust::Start()
{
	__super::Start();
	
	m_pModelCom = m_pOwner.lock()->Get_Component<CModel>();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_AvoidAttack_E2");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_AVoidThrust::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_AVoidThrust::Tick(_float fTimeDelta)
{
...
void CCorvusState_AVoidThrust::LateTick(_float fTimeDelta)
{
...
void CCorvusState_AVoidThrust::Check_InputAgainAvoid()
{
...
void CCorvusState_AVoidThrust::OnDisable()
{

}

void CCorvusState_AVoidThrust::OnStateStart(const _float& In_fAnimationBlendTime)
{
...
void CCorvusState_AVoidThrust::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_AVoidThrust::Free()
{
	if (m_pModelCom.lock())
		m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_AVoidThrust::Call_AnimationEnd, this, placeholders::_1);
}

_bool CCorvusState_AVoidThrust::Check_AndChangeNextState()
{
...
_bool CCorvusState_AVoidThrust::Check_RuquireMnetRepeatAvoidkState()
{
