...
GAMECLASS_C(CCorvusState_AVoidB);
CLONE_C(CCorvusState_AVoidB, CComponent)

HRESULT CCorvusState_AVoidB::Initialize_Prototype()
{
	__super::Initialize_Prototype();
	return S_OK;
}

HRESULT CCorvusState_AVoidB::Initialize(void* pArg)
{
...
void CCorvusState_AVoidB::Start()
{
	__super::Start();
	
	m_pModelCom = m_pOwner.lock()->Get_Component<CModel>();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_AvoidShortMag_B");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_AVoidB::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_AVoidB::Tick(_float fTimeDelta)
{
...
void CCorvusState_AVoidB::LateTick(_float fTimeDelta)
{
...
void CCorvusState_AVoidB::Check_InputAgainAvoid()
{
...
void CCorvusState_AVoidB::OnDisable()
{

}

void CCorvusState_AVoidB::OnStateStart(const _float& In_fAnimationBlendTime)
{
	__super::OnStateStart(In_fAnimationBlendTime);

	if (Get_OwnerCharacter().lock()->Get_PreState().lock() == Get_Owner().lock()->Get_Component<CCorvusState_AVoidB>().lock())
	{
...
void CCorvusState_AVoidB::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_AVoidB::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_AVoidB::Play_AttackWithIndex(const _tchar& In_iAttackIndex)
{
	
	m_pModelCom.lock()->Set_CurrentAnimation(m_iAnimIndex);
}

void CCorvusState_AVoidB::Free()
{

}

void CCorvusState_AVoidB::OnDestroy()
{
	if (m_pModelCom.lock())
		m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_AVoidB::Call_AnimationEnd, this, placeholders::_1);
}

_bool CCorvusState_AVoidB::Check_AndChangeNextState()
{
...
_bool CCorvusState_AVoidB::Check_RuquireMnetRepeatAvoidkState()
{
