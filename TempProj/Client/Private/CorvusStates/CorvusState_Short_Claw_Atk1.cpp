...
GAMECLASS_C(CCorvusState_Short_Claw_Atk1);
CLONE_C(CCorvusState_Short_Claw_Atk1, CComponent)

HRESULT CCorvusState_Short_Claw_Atk1::Initialize_Prototype()
{
...
HRESULT CCorvusState_Short_Claw_Atk1::Initialize(void* pArg)
{
...
void CCorvusState_Short_Claw_Atk1::Start()
{
	__super::Start();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_Raven_ClawShortV2_Fast01");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Short_Claw_Atk1::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_Short_Claw_Atk1::Tick(_float fTimeDelta)
{
...
void CCorvusState_Short_Claw_Atk1::LateTick(_float fTimeDelta)
{
...
void CCorvusState_Short_Claw_Atk1::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Short_Claw_Atk1::Call_NextAnimationKey(const _uint& In_iKeyIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_Short_Claw_Atk1::Attack()
{

}

void CCorvusState_Short_Claw_Atk1::Check_InputNextAttack()
{
...
void CCorvusState_Short_Claw_Atk1::OnStateStart(const _float& In_fAnimationBlendTime)
{
...
void CCorvusState_Short_Claw_Atk1::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_Short_Claw_Atk1::OnEventMessage(_uint iArg)
{
...
void CCorvusState_Short_Claw_Atk1::OnDestroy()
{
	m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_Short_Claw_Atk1::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_Short_Claw_Atk1::Free()
{

}

_bool CCorvusState_Short_Claw_Atk1::Check_AndChangeNextState()
{
...
_bool CCorvusState_Short_Claw_Atk1::Check_RequirementNextAttackState()
{
...
_bool CCorvusState_Short_Claw_Atk1::Check_RuquireMnetFirstAttackState()
{
