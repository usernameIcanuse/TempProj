...
void CCorvusState_Climb_R_Down_End::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_Climb_R_Down_End::Call_AnimationEnd, this, placeholders::_1);
}
...
void CCorvusState_Climb_R_Down_End::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
