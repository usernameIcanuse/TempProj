...
HRESULT CCorvusState_LAttack4::Initialize_Prototype()
{
...
HRESULT CCorvusState_LAttack4::Initialize(void* pArg)
{
	__super::Initialize(pArg);

	m_vShakingOffSet = { -1.f,-0.4f,0.f };

	return S_OK;
}

void CCorvusState_LAttack4::Start()
{
	__super::Start();
	m_iAnimIndex = m_pModelCom.lock()->Get_IndexFromAnimName("Corvus_SD_LAttack4");
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CCorvusState_LAttack4::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_LAttack4::Tick(_float fTimeDelta)
{
...
void CCorvusState_LAttack4::LateTick(_float fTimeDelta)
{
...
void CCorvusState_LAttack4::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
...
void CCorvusState_LAttack4::Play_AttackWithIndex(const _tchar& In_iAttackIndex)
{
...
void CCorvusState_LAttack4::Attack()
{

}

void CCorvusState_LAttack4::Check_InputNextAttack()
{
...
void CCorvusState_LAttack4::OnStateStart(const _float& In_fAnimationBlendTime)
{
...
void CCorvusState_LAttack4::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_LAttack4::OnDestroy()
{
	m_pModelCom.lock()->CallBack_AnimationEnd -= bind(&CCorvusState_LAttack4::Call_AnimationEnd, this, placeholders::_1);
}

void CCorvusState_LAttack4::Free()
{

}

_bool CCorvusState_LAttack4::Check_AndChangeNextState()
{
...
_bool CCorvusState_LAttack4::Check_RequirementNextAttackState()
{
...
_bool CCorvusState_LAttack4::Check_RuquireMnetFirstAttackState()
{
