...
GAMECLASS_C(CCorvusState_LAttack5);
CLONE_C(CCorvusState_LAttack5, CComponent)

HRESULT CCorvusState_LAttack5::Initialize_Prototype()
{
...
HRESULT CCorvusState_LAttack5::Initialize(void* pArg)
{
	__super::Initialize(pArg);

	m_vShakingOffSet = { 0.2f,1.f,0.f };
...
void CCorvusState_LAttack5::LateTick(_float fTimeDelta)
{
...
void CCorvusState_LAttack5::Play_AttackWithIndex(const _tchar& In_iAttackIndex)
{
...
void CCorvusState_LAttack5::Attack()
{

}

void CCorvusState_LAttack5::Check_InputNextAttack()
{
...
void CCorvusState_LAttack5::OnStateStart(const _float& In_fAnimationBlendTime)
{
	...
	m_pPhysXControllerCom.lock()->Callback_ControllerHit +=
		bind(&CCorvusState_LAttack5::Call_OtherControllerHit, this, placeholders::_1);
...
void CCorvusState_LAttack5::OnStateEnd()
{
	__super::OnStateEnd();
...
void CCorvusState_LAttack5::OnEventMessage(_uint iArg)
{
...
_bool CCorvusState_LAttack5::Check_AndChangeNextState()
{
...
_bool CCorvusState_LAttack5::Check_RequirementNextAttackState()
{
...
_bool CCorvusState_LAttack5::Check_RuquireMnetFirstAttackState()
{
