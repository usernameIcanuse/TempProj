...
void CBigHandManState_Walk::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CBigHandManState_Walk::Call_AnimationEnd, this, placeholders::_1);
}
...
void CBigHandManState_Walk::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
