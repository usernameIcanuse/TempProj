...
void CJokerState_Combob1::Start()
{
	...
	m_pModelCom.lock()->CallBack_AnimationEnd += bind(&CJokerState_Combob1::Call_AnimationEnd, this, placeholders::_1);
}
...
void CJokerState_Combob1::Call_AnimationEnd(_uint iEndAnimIndex)
{
	if (!Get_Enable())
		return;
