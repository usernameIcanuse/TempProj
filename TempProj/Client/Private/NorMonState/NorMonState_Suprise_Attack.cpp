...
_bool CNorMonState_Suprise_Attack::Check_AndChangeNextState()
{
	...
	if (fDistance <= 4.f)
	{
		...
		case Client::MONSTERTYPE::AXEMAN:
		{
			Get_OwnerCharacter().lock()->Change_State<CNorMonState_HeavyAttack1>(0.1f);
		}
			break;
		case Client::MONSTERTYPE::KNIFEWOMAN:
		{
		...
		case Client::MONSTERTYPE::GARDENER:
		{
			Get_OwnerCharacter().lock()->Change_State<CNorMonState_HeavyAttack2>(0.1f);
		}
			break;
		case Client::MONSTERTYPE::SHIELDAXEMAN:
		{
			Get_OwnerCharacter().lock()->Change_State<CNorMonState_HeavyAttack3>(0.1f);
		}
			break;
		case Client::MONSTERTYPE::ENHANCE_GARDENER:
		{
		...
		case Client::MONSTERTYPE::SKULLSPEARMAN:
		{
			Get_OwnerCharacter().lock()->Change_State<CNorMonState_LightAttack2>(0.1f);
		}
			break;
		case Client::MONSTERTYPE::ARMORSHIELDMAN:
		{
		...
		case Client::MONSTERTYPE::ARMORSPEARMAN:
		{
			Get_OwnerCharacter().lock()->Change_State<CNorMonState_LightAttack1>(0.1f);
		}
			break;
		case Client::MONSTERTYPE::WEAKARMORSPEARMAN:
		{
